...
describe GoogleChart::VennDiagram do
  ...
  it "should accept a maximum of 3 intersection points" do
    @venn.data "Circle 1", 5
    @venn.data "Circle 2", 5
    @venn.data "Circle 3", 5
    @venn.intersections 2,3,4
  ...
  it "should raise error if number of intersections is greater than the number of data points" do
    @venn.data "Circle 1", 5
    @venn.data "Circle 2", 5
    lambda { @venn.intersections 2,3,4 }.should raise_error(ArgumentError)
  end
